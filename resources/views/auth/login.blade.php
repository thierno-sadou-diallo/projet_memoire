...
<div class="container-fluid login-wrapper">
    <div class="login-card">
        <!-- Image à gauche -->
        <img src="{{ asset('images/photo_connect.png') }}" alt="Image connexion" class="login-image">
        ...
        <div class="login-form">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="text-center">
                    ...
                    <a href="{{ route('register') }}" class="text-decoration-none text-primary fw-bold">Créer un compte</a>
                </div>
            </form>
        </div>
    </div>
