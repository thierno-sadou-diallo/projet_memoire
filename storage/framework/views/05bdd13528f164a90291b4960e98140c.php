    ...
    <div class="row">
        ...
        <div class="col-md-2 sidebar p-0">
            <div>
                ...
                <a href="<?php echo e(route('memoires')); ?>" ><i class="fa fa-book me-2"></i> Mémoires</a>
            ...
            <form method="POST" action="<?php echo e(route('logout')); ?>" class="m-3">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\user\projet_memoire\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>